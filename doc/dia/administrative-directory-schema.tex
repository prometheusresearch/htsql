...
\node[table] (school) [right=3 of department.south east, anchor=south west]
{
    School
    \nodepart{second}
    \begin{columns}
...
\node[table] (course) [below=3 of department]
{
    Course
    \nodepart{second}
    \begin{columns}
...
\coordinate (school/department/l)
    at (department/school -| school.second west);
...
\coordinate (school/code/r)
    at ($ (school.text split east)!.25!(school.second split east) $);
